<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoiMatKhau.aspx.cs" Inherits="WebBanHang.DoiMatKhau" %>
                        ...
                        <div class="login-form">
                            <form method="post" runat="server">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtMatKhauCu" runat="server" class="au-input au-input--full" TextMode="Password"></asp:TextBox>
                                    <asp:Label ID="lbMatKhauCu" runat="server" Text="" ForeColor="Red"></asp:Label>
                                </div>
                                <div class="form-group">
                                    <label>Mật khẩu mới</label>
                                    <asp:TextBox ID="txtMatKhauMoi" runat="server" class="au-input au-input--full" TextMode="Password"></asp:TextBox>
                                    <asp:Label ID="lbMatKhauMoi" runat="server" Text="" ForeColor="Red"></asp:Label>
                                </div>
                                <div class="form-group">
                                    <label>Xác nhận mật khẩu mới</label>
                                    <asp:TextBox ID="txtXacNhan" runat="server" class="au-input au-input--full" TextMode="Password"></asp:TextBox>
                                    <asp:Label ID="lbXacNhan" runat="server" Text="" ForeColor="Red"></asp:Label>
                                </div>
                                <asp:Literal ID="ltlThongBao" runat="server"></asp:Literal>
                                
                                <asp:Button ID="btnDoiMatKhau" runat="server" Text="Đổi" class="au-btn au-btn--block au-btn--green m-b-20" OnClick="Doi"/>
