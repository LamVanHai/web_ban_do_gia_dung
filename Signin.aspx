<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signin.aspx.cs" Inherits="WebBanHang.Signin" %>
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <h2><asp:Label ID="Label6" runat="server" Text="Đăng ký tài khoản"></asp:Label></h2>
                            </a>
                        </div>
                        <div class="login-form">
                            <form method="post" runat="server">
                                <div class="form-group">
                                    <asp:Label ID="Label1" runat="server">Tên</asp:Label>
                                    <asp:TextBox ID="txtTen" runat="server"  class="au-input au-input--full"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" SetFocusOnError="True" Display="Dynamic" ControlToValidate="txtTen" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <asp:Label ID="Label3" runat="server">Mật khẩu</asp:Label>
                                    <asp:TextBox ID="txtMatKhau" runat="server" class="au-input au-input--full" TextMode="Password"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" SetFocusOnError="True" Display="Dynamic" ControlToValidate="txtMatKhau" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group">
                                    <asp:Label ID="Label7" runat="server">Xác nhận mật khẩu</asp:Label>
                                    <asp:TextBox ID="txtMatKhau1" runat="server" class="au-input au-input--full" TextMode="Password"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" SetFocusOnError="True" Display="Dynamic" ControlToValidate="txtMatKhau1" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group">
                                    <asp:Label ID="Label4" runat="server">Địa chỉ</asp:Label>
                                ...
                                <div class="form-group">
                                    <asp:Label ID="Label5" runat="server">Số điện thoại</asp:Label>
                                ...
                                <asp:Button ID="btnDangKy" runat="server" Text="Đăng ký" class="au-btn au-btn--block au-btn--green m-b-20" OnClick="DangKy"/>
                                    
                                <asp:Button ID="btnDangNhap" runat="server" Text="Đăng nhập" class="au-btn au-btn--block au-btn--green m-b-2" OnClick="DangNhap"/>
